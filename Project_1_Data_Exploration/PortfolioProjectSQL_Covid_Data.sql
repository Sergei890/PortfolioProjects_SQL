...
-- We see that the highest % of population infected with Covid in Germany was in fact on 2021-12-06 (Basically at the timeframe of writing this portfolio)
----------------------------------------------------------------------------------------------------------------------------------------------------------
...
-- We see that the highest Infection Rate is was observed in Montenegro with 25.26% of population being infected at some point in time.
----------------------------------------------------------------------------------------------------------------------------------------------------------
...
, SUM(CONVERT(bigint,vac.new_vaccinations)) OVER (Partition by dea.Location Order by dea.location, dea.Date) as RollingPeopleVaccinated  -- Sum up by countries only.
